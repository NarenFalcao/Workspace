...
public class GameSolver
{
    ...
    public static int findIndexOfProfile(int [] temp)
    {
      ...
      //  System.out.println("Prof:" +NoOfStrategyProfiles);
        for(i=0;i<NoOfStrategyProfiles;i++)
        {
        //	System.out.print("Iposprof:" +possibleProfiles[i] +"\n");
    ...
    //	System.out.println("size" +temp.length);
        ...
        //System.out.println(possibleProfiles[index].getPayoff(i));
    ...
    public static void findNashEquilibria()
    {
       ...
       // System.out.println("HHH" +NoOfStrategyProfiles);
        ...
        main_for:        for(j=0;j<NoOfStrategyProfiles;j++)
        {
            ...
            NashEquilibria.add(j);  // adding all j for nash profiles
...
main_for:       for(strategy=1;strategy<=actions[i];strategy++)
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        for(i=0;i<NoOfStrategyProfiles;i++)
        {
            ...
            //    System.out.println(payoff[k]);
                possibleProfiles[i].addPayoff(payoff[k]);
                
                k++;
            }
            System.out.println("PossibleProf Payoff:" +possibleProfiles[i].getPayoffs());
            System.out.println("PossibleProf Profile:" +possibleProfiles[i].getProfile());
           // for(int o=0;o<temp.length;o++)
           // 	System.out.println("temp before:" +temp[o]);
            func(0,NoOfPlayers); //changing the temp values here
             
           // for(int o=0;o<temp.length;o++)
           // 	System.out.println("temmp after:" +temp[o]);
        }
        ...
        else
        {
            ...
            for(i=0;i<NashEquilibria.size();i++)
            {
                ...
                System.out.println("INDEX NASH" +index);
...
class StrategyProfile       //The strategy profile and the corresponding payoffs
{
    ...
    boolean compareProfile(int [] temp) //compares strategy profile to temp[] values
    {
       ...
       // 	System.out.println(profile);
            if(!(profile.get(i).equals(temp[i])))
            {
